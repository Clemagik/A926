...
static struct ingenic_div_clock x2000_div_clks[] __initdata = {
	DIV(CLK_DIV_DDR,		"div_ddr",		"mux_ddr",		CPM_DDRCDR,	4,  0),
	DIV(CLK_DIV_MACPHY,		"div_macphy",		"mux_macphy",		CPM_MACCDR,	8,  0),
	DIV(CLK_DIV_MACTXPHY,		"div_mactxphy0",	"mux_mactxphy",		CPM_MACTXCDR,	8,  0),
	DIV(CLK_DIV_MACTXPHY1,		"div_mactxphy1",	"mux_mactxphy1",	CPM_MACTXCDR1,	8,  0),
	DIV(CLK_DIV_MACPTP,		"div_macptp",		"mux_macptp",		CPM_MACPTP,	8,  0),
	DIV(CLK_DIV_LCD,		"div_lcd",		"mux_lcd",		CPM_LPCDR,	8,  0),
	DIV(CLK_DIV_MSC0,		"div_msc0",		"mux_msc0",		CPM_MSC0CDR,	8,  CLK_DIVIDER_QUADRUPLE),
	DIV(CLK_DIV_MSC1,		"div_msc1",		"mux_msc1",		CPM_MSC1CDR,	8,  CLK_DIVIDER_QUADRUPLE),
	DIV(CLK_DIV_MSC2,		"div_msc2",		"mux_msc2",		CPM_MSC2CDR,	8,  CLK_DIVIDER_QUADRUPLE),
	DIV(CLK_DIV_SFC,		"div_sfc",		"mux_sfc",		CPM_SFCCDR,	8,  0),
	DIV(CLK_DIV_SSI,		"div_ssi",		"mux_ssi",		CPM_SSICDR,	8,  0),
	DIV(CLK_DIV_CIM,		"div_cim",		"mux_cim",		CPM_CIMCDR,	8,  0),
	DIV(CLK_DIV_PWM,		"div_pwm",		"mux_pwm",		CPM_PWMCDR,	4,  0),
	DIV(CLK_DIV_ISP,		"div_isp",		"mux_isp",		CPM_ISPCDR,	4,  0),
	DIV(CLK_DIV_RSA,		"div_rsa",		"mux_rsa",		CPM_RSACDR,	4,  0),
...
static struct ingenic_gate_clock x2000_gate_clks[] __initdata = {
	...
	GATE(CLK_GATE_DDR,	"gate_ddr",		"div_ddr",	CPM_CLKGR,  31, CLK_IGNORE_UNUSED | CLK_SET_RATE_PARENT, 0),
//	GATE(CLK_GATE_IPU,	"gate_ipu",		"div_ipu",	CPM_CLKGR,  30, 0, CLK_GATE_SET_TO_DISABLE),
	GATE(CLK_GATE_AHB0,	"gate_ahb0",		"div_ahb0",	CPM_CLKGR,  29, 0, 0),
	GATE(CLK_GATE_APB0,	"gate_apb0",		"div_ahb0",	CPM_CLKGR,  28, 0, CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_OST,	"gate_ost",		"ext",		CPM_CLKGR,  20, 0, CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_ARB,	"gate_arb",		"div_ahb0",	CPM_CLKGR1, 30, 0, CLK_GATE_SET_TO_DISABLE),
	...
	GATE(CLK_GATE_INTC,	"gate_intc",		"div_ahb2",	CPM_CLKGR1, 26, 0, CLK_GATE_SET_TO_DISABLE),
