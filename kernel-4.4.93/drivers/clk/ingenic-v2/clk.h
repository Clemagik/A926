...
#define DIV(_id, cname, pname, o, w, df)				\
	__DIV(_id, NULL, cname, pname, o, 0, w, 28, 29, 27, 0, df, cname, NULL)
...
struct ingenic_power_clock {
	...
	u8			gate_flags;
	const char		*alias;
#define CLK_IS_REGISTERED	BIT(1)
	unsigned long 		clk_flags;
};

#define __POWER(_id, dname, cname, pname, f, o, cb, wb, dm, gf, a)	\
	{							\
		.id		= _id,				\
		.dev_name	= dname,			\
		.name		= cname,			\
...
#define POWER(_id, cname, pname, o, cb, wb, f, gf, dm)			\
	__POWER(_id, NULL, cname, pname, f, o, cb, wb, dm, gf, cname)
