...
static int __rn5t567_reg_read(struct i2c_client *i2c, u8 reg)
{
	return i2c_smbus_read_byte_data(i2c, reg);
}

static int __rn5t567_reg_write(struct i2c_client *i2c, u8 reg, u8 val)
{
...
static void rn5t567_reg_default_init(struct i2c_client *i2c)
{
	...
	for (i = 0, reg = 0; i < RN5T567_REG_NUM &&
		...
		def = __rn5t567_reg_read(i2c, (u8)reg);
		if (def < 0) {
