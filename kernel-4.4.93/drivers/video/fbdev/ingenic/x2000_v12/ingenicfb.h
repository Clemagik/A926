...
struct ingenicfb_lay_cfg {
	...
	unsigned int addr[DPU_SUPPORT_MAX_FRAMES];
};
...
struct ingenicfb_frm_mode {
	...
	frm_cfg_st_t update_st[CONFIG_FB_INGENIC_NR_FRAMES];
};
...
struct ingenicfb_device {
	...
	size_t frm_size;
	struct ingenicfb_framedesc *framedesc[CONFIG_FB_INGENIC_NR_FRAMES];
	dma_addr_t framedesc_phys[CONFIG_FB_INGENIC_NR_FRAMES];
	struct ingenicfb_layerdesc *layerdesc[CONFIG_FB_INGENIC_NR_FRAMES][DPU_SUPPORT_MAX_LAYERS];
	dma_addr_t layerdesc_phys[CONFIG_FB_INGENIC_NR_FRAMES][DPU_SUPPORT_MAX_LAYERS];
