...
#define FW_BCM43438A0 "fw_43438_a0"
#define FW_BCM43438A1 "fw_43438_a1"
...
#define NV_BCM4330B2 "nv_bcm40183b2"
#define NV_BCM4330B2_AG "nv_bcm40183b2_ag"
#define NV_BCM43362A0 "nv_bcm40181a0"
#define NV_BCM43362A2 "nv_bcm40181a2"
#define NV_BCM4334B1 "nv_bcm4334b1_ag"
/* #define NV_BCM43438A0 "nv_bcm43438a0" */
/* #define NV_BCM43438A1 "nv_bcm43438a1" */
#define NV_BCM43438A0 "nv_43438_a0"
#define NV_BCM43438A1 "nv_43438_a1"
#define NV_BCM43436B0 "nv_bcm43436b0"
#define NV_BCM43013B0 "nv_bcm43013b0"
#define NV_BCM43341B1 "nv_bcm43341b0_ag"
#define NV_BCM43241B4 "nv_bcm43241b4_ag"
#define NV_BCM4339A0 "nv_bcm4339a0_ag"
#define NV_BCM43455C0 "nv_bcm43455c0_ag"
#define NV_BCM43456C5 "nv_bcm43456c5_ag"
#define NV_BCM4354A1 "nv_bcm4354a1_ag"
#define NV_BCM4356A2 "nv_bcm4356a2_ag"
#define NV_BCM4358A3 "nv_bcm4358a3_ag"
#define NV_BCM4359B1 "nv_bcm4359b1_ag"
#define NV_BCM4359C0 "nv_bcm4359c0_ag"
#endif
#ifdef BCMPCIE
#define NV_BCM4356A2 "nv_bcm4356a2_pcie_ag"
#endif
...
dhd_conf_set_nv_name_by_chip(dhd_pub_t *dhd, char *nv_path)
{
	...
	ag_type = FW_TYPE_AG;
#else
	ag_type = strstr(&nv_path[i], "_ag") ? FW_TYPE_AG : FW_TYPE_G;
#endif
	nv_type = (strstr(&nv_path[i], "_mfg") ? FW_TYPE_MFG :
			   (strstr(&nv_path[i], "_apsta") ? FW_TYPE_APSTA :
				(strstr(&nv_path[i], "_p2p") ? FW_TYPE_P2P :
				 (strstr(&nv_path[i], "_es") ? FW_TYPE_ES :
				  FW_TYPE_STA))));

	if (nv_type == FW_TYPE_STA)
		strcpy(nv_tail, ".cal");
	else if (nv_type == FW_TYPE_APSTA)
		strcpy(nv_tail, "_apsta.bin");
	else if (nv_type == FW_TYPE_P2P)
		strcpy(nv_tail, "_p2p.bin");
	else if (nv_type == FW_TYPE_ES)
		strcpy(nv_tail, "_es.bin");
	else if (nv_type == FW_TYPE_MFG)
		strcpy(nv_tail, "_mfg.bin");
	...
	case BCM4330_CHIP_ID:
		if (ag_type == FW_TYPE_G) {
			...
			if (chiprev == BCM4330B2_CHIP_REV)
				strcpy(&nv_path[i+1], NV_BCM4330B2_AG);
		}
		break;
	case BCM43362_CHIP_ID:
		if (chiprev == BCM43362A0_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM43362A0);
		else
			strcpy(&nv_path[i+1], NV_BCM43362A2);
		break;
	case BCM43430_CHIP_ID:
		if (chiprev == BCM43430A0_CHIP_REV)
			...
			strcpy(&nv_path[i+1], NV_BCM43436B0);
		break;
	case BCM43012_CHIP_ID:
		if (chiprev == BCM43013B0_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM43013B0);
		break;
	case BCM4334_CHIP_ID:
		if (chiprev == BCM4334B1_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM4334B1);
		break;
	case BCM43340_CHIP_ID:
	case BCM43341_CHIP_ID:
		if (chiprev == BCM43341B0_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM43341B1);
		break;
	case BCM4324_CHIP_ID:
		if (chiprev == BCM43241B4_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM43241B4);
		break;
	case BCM4335_CHIP_ID:
		if (chiprev == BCM4335A0_CHIP_REV)
	...
	case BCM43454_CHIP_ID:
		if (chiprev == BCM43455C0_CHIP_REV)
			...
			strcpy(&nv_path[i+1], NV_BCM43456C5);
		break;
	case BCM4354_CHIP_ID:
		if (chiprev == BCM4354A1_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM4354A1);
		else if (chiprev == BCM4356A2_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM4356A2);
		break;
	case BCM4356_CHIP_ID:
	case BCM4371_CHIP_ID:
		if (chiprev == BCM4356A2_CHIP_REV)
	...
	case BCM43569_CHIP_ID:
		if (chiprev == BCM4358A3_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM4358A3);
		break;
	case BCM4359_CHIP_ID:
		if (chiprev == BCM4359B1_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM4359B1);
		else if (chiprev == BCM4359C0_CHIP_REV)
			strcpy(&nv_path[i+1], NV_BCM4359C0);
		break;
#endif
#ifdef BCMPCIE
	case BCM4354_CHIP_ID:
...
#endif
	default:
		strcpy(&nv_path[i+1], "nv_bcmdhd");
	}
	strcat(nv_path, nv_tail);
#endif
