/* include/linux/power/ingenic_battery.h
 ...
 */
#ifndef __INGENIC_BATTERY_H
#define __INGENIC_BATTERY_H
...
struct ingenic_battery_platform_data {
	struct ingenic_battery_info info;
};
...
struct ingenic_battery {
	struct ingenic_battery_platform_data *pdata;
